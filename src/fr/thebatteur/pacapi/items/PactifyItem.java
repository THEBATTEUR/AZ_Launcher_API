package fr.thebatteur.pacapi.items;

import fr.thebatteur.pacapi.utils.NBTUtil;
import net.minecraft.server.v1_9_R2.NBTTagCompound;
import org.bukkit.Material;
import org.bukkit.craftbukkit.v1_9_R2.inventory.CraftItemStack;
import org.bukkit.inventory.ItemStack;

public class PactifyItem {

    private ItemStack itemStack;

    public PactifyItem(ItemStack itemStack) {
        this.itemStack = itemStack;
    }

    public PactifyItem addPacDisplay(PacDisplay display) {
        System.out.println(display.getNbtUtil().toString());
        this.addNBTTags("PacDisplay", display.getNbtUtil().toNBT());
        return this;
    }

    public PactifyItem addPacRender(PacRender render) {
        this.addNBTTags("PacRender", render.getNbtUtil().toNBT());
        return this;
    }

    public PactifyItem addPacMenu(PacMenu menu) {
